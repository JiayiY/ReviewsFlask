...
#   'Accept': 'text/htmlop,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8',
#   'Accept-Language': 'en',
# }
...
DOWNLOADER_MIDDLEWARES = {
    ...
    'reviews.MyUserAgentMiddleware.MyUserAgentMiddleware': 543,
    # 'reviews.middlewares.MyUserAgentMiddleware': 500,
}
...
MYSQL_PORT = '3306'
MYSQL_DBNAME = 'db_reviews'  # 数据库名字
MYSQL_USER = 'root'  # 数据库登录名
MYSQL_PASSWD = '1021'  # 数据库登录密码

DUPEFILTER_CLASS = "scrapy_redis.dupefilter.RFPDupeFilter"
SCHEDULER = "scrapy_redis.scheduler.Scheduler"
SCHEDULER_PERSIST = True
# ITEM_PIPELINES ={
#     'scrapy_redis.pipelines.RedisPipelines': 100,
# }
